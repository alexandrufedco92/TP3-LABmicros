...
#define US_TO_PULSES_MAX(t) ( (t/1000000UL)*SYSTICK_ISR_FREQ_HZ) //Asume que recibe el t en milisegundos.
#define US_TO_PULSES_MIN(t) ( (t*SYSTICK_ISR_FREQ_HZ)/1000000UL ) //Asume que recibe el t en milisegundos.
