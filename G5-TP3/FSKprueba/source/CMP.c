...
void initCMP(cmps_ids id){
	...
	//enableInterrupts();		//no usamos interrupciones
...
void configureDAC(){		//configuro dac interno para tener la tension de referencia 1.65V
...
void CMP0_IRQHandler(void){			//funcion no utilizada ya que no llamamos al cpu
